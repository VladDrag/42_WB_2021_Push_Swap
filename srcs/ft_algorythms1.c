...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/21 15:16:06 by vdragomi          #+#    #+#             */
/*   Updated: 2021/11/22 08:30:07 by vdragomi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_algo_four(t_list **stack_a, t_list **stack_b)
{
	int	index;
...
int	ft_sorting_check(t_list **stack_a)
{
	t_list	*temporary;
	int		values[3];
